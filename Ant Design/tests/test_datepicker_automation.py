...
Step definitions are automatically matched from steps/datepicker_steps.py
"""
...
# pytest-bdd will automatically match feature file steps to step definitions in steps/datepicker_steps.py
scenarios('../features/datepicker_automation.feature')
